 ...
 */
public class CongressHCP extends JPanel {
	...
	public static JFrame demo() {
		...
		try {
			...
			t = new DelimitedTextTableReader().readTable("WHOHealthCarePersonnel.txt"); 
		} catch ( Exception e ) {
			e.printStackTrace();
			System.exit(1);
		}
		...
		JFrame frame = new JFrame("W H O |  H E A L T H C A R E  P E R S O N N E L");
		frame.setContentPane(new CongressHCP(t));
		frame.pack();
	...
	//
	private static final String TOTAL_RECEIPTS = "Nursing_Midwifes";
	private static final String RECEIPTS = "Nursing_Midwifes";
	//
	...
	public CongressHCP(Table t) {
		...
		vt.addColumn("label", 
				"CONCAT(CAP(Country), ' (', " 
						+ "CAP([NOC]), '-', [Country], "
						+ "') - NOP: ', [NOP], ', Nursing midwifies: ', [Nursing_Midwifes], ', Pharmaceutical: ', [Pharmaceutical])");
		//
		...
		receiptsQ.getNumberModel().setValueRange(0,800000,0,800000);
		...
		//
		DataColorAction color = new DataColorAction(group, "Pharmaceutical",
